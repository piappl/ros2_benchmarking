...
#ifndef ROBOT_INFORMATION_MSGS__MSG__ROBOT_STATUS__TYPE_SUPPORT_H_
#define ROBOT_INFORMATION_MSGS__MSG__ROBOT_STATUS__TYPE_SUPPORT_H_
...
#endif  // ROBOT_INFORMATION_MSGS__MSG__ROBOT_STATUS__TYPE_SUPPORT_H_

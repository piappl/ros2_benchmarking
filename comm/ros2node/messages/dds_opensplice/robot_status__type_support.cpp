...
#include "robot_information_msgs/msg/dds_opensplice/robot_status__type_support.hpp"
...
using __ros_msg_type = robot_information_msgs::msg::RobotStatus;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_robot_information_msgs
const char *
register_type__RobotStatus(
...
convert_dds_message_to_ros(const __dds_msg_type & dds_message, __ros_msg_type & ros_message)
{
  // field.name battery
  ros_message.battery =
    dds_message.battery_;

  // field.name turtle_factor
  ros_message.turtle_factor =
    dds_message.turtle_factor_;

  // field.name battery_charging
  ros_message.battery_charging =
    dds_message.battery_charging_ == TRUE;
  ...
  // field.name brake_active
  ros_message.brake_active =
    dds_message.brake_active_ == TRUE;
...
get_message_type_support_handle_opensplice<
  robot_information_msgs::msg::RobotStatus
>()
{

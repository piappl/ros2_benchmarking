...
#include "robot_information_msgs/msg/robot_control__functions.h"
...
ROSIDL_GET_TYPE_SUPPORT_FUNCTION(robot_information_msgs, msg, RobotControl)();


using __dds_msg_type = robot_information_msgs::msg::dds_::RobotControl_;
using __ros_msg_type = robot_information_msgs__msg__RobotControl;
...
convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  ...
  // Field name: turtle
  {
    ros_message->turtle = dds_message->turtle_;
  }

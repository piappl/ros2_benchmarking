...
FIND_PATH(OpenSplice_INCLUDE_DIR
	NAMES
		make_files.py
	PATHS
		$ENV{OSPL_HOME}/install/HDE/$ENV{SPLICE_TARGET}/include/dcps/C++/isocpp
)
...
message($ENV{OSPL_HOME}/lib/$ENV{SPLICE_TARGET})
message(${KERNEL_LIBRARY})
...
#message(BEFORE!${OpenSplice_IDLGEN_BINARY}!BEFORE)
SET (OpenSplice_IDLGEN_BINARY $ENV{OSPL_HOME}/exec/$ENV{SPLICE_TARGET}/idlpp)
#message(AFTER!${OpenSplice_IDLGEN_BINARY}!AFTER)

...
docker run -d -h master --net ros1 --ip $net_ros1_bridge -e $master_uri --add-host console:$net_ros1_console --add-host robot:$net_ros1_robot -v $PWD/logs:/logs ros2:bridge bash -c "$cmd"

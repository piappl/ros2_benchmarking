...
docker run -d -h qtcreator -v /tmp/.X11-unix:/tmp/.X11-unix -v /tmp/.docker.xauth:/tmp/.docker.xauth -v $2:/ros2_benchmarking -e XAUTHORITY=/tmp/.docker.xauth -e DISPLAY $1:base /bin/bash -c "$cmd"

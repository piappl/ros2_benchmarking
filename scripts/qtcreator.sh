...
docker run -ti -h qtcreator --rm -v /tmp/.X11-unix:/tmp/.X11-unix -v /tmp/.docker.xauth:/tmp/.docker.xauth -v /home/rkozik/r5cop_benchmarking:/r5cop_benchmarking -e XAUTHORITY=/tmp/.docker.xauth -e DISPLAY test:$1 /bin/bash -c "$cmd"
